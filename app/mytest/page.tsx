...
export default function Home() {
  ...
  return (
    <div
      ...
      "
    >
      {/* <div className="flex-col items-center justify-center content-center mx-auto p-10"> */}
        ...
        <ul className="grid grid-cols-1 gap-4 mb-10 sm:grid-cols-2 md:grid-cols-3 md:gap-8">
          <li className="bg-brand-yellow rounded-lg shadow-xl">
            <div className="h-24 w-36 flex items-center justify-center text-center font-bold text-ftnal-white text-body-s lg:text-body-l">
              brand-yellow
            </div>
          </li>
          ...
          <li className="bg-ftnal-white rounded-lg shadow-xl">
            <div className="h-24 w-36 flex items-center justify-center font-bold text-ftnal-black text-body-s lg:text-body-l">
              ftnal-white
            </div>
          </li>
